...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_ont7t3e', 'template_p0wjgtl', formRef.current, {
            publicKey: '0yQQ9t1TgYLmuDmZq',
          })
          .then(
            () => {
              setSuccess(true);
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div variants={variants} className="item">
          <h2>Mail</h2>
          <span>harshmoye03@gmail.com</span>
        </motion.div>
        <motion.div variants={variants} className="item">
          <h2>Phone</h2>
          <span>+91 9421186486</span>
        </motion.div>
        <motion.div variants={variants} className="item">
          <h2>Address</h2>
          <span>
            HS-03 , Aquem Plaza Complex , Aquem-Baixo , Shantinagar , Navelim ,
            Goa-403707
          </span>
        </motion.div>
      </motion.div>
